...
The usage details can be found in the README of corresponding branch. The following part is about the usage of ``ccl_torch1.6`` of torch-ccl. if you want to use other version of torch-ccl please checkout to that branch(tag).
